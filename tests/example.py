...
enpyObj = Enpy('./filetest/train.json')
...
# Create nodes.csv
enpyObj.getNodesJson2Csv('./filetest/nodes.csv', 'ingredients', 'id')

# save names of each edges
enpyObj.getNamesJson2Csv('./filetest/nodes_name.csv', 'ingredients')
